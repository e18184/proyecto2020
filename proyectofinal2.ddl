...
CREATE TABLE gestion2019.carreras (idcarr serial NOT NULL, nombre varchar(40) NOT NULL, direccion varchar(60), telefono varchar(15), activo bool NOT NULL, CONSTRAINT carreras_pkey PRIMARY KEY (idcarr));
...
CREATE TABLE gestion2019.datos (idusu int4 NOT NULL, login varchar(15) NOT NULL, password varchar(100) NOT NULL, activo bool NOT NULL, CONSTRAINT datos_pkey PRIMARY KEY (idusu, login));
...
CREATE TABLE gestion2019.dicta (iddicta serial NOT NULL, idusu int4 NOT NULL, idcarr int4, sigla char(6), gestion char(4), materiasparalelo char(1), grupoid_grupo int4, Estado bool NOT NULL, CONSTRAINT dicta_pkey PRIMARY KEY (iddicta, idusu));
...
CREATE TABLE gestion2019.docentes (idusu int4 NOT NULL, auxiliar bool NOT NULL, CONSTRAINT docentes_pkey PRIMARY KEY (idusu));
...
CREATE TABLE gestion2019.grupo (id_grupo SERIAL NOT NULL, idcarr int4 NOT NULL, sigla char(6) NOT NULL, nombre varchar(40) NOT NULL, cargahoraria int2 NOT NULL, "plan" varchar(4) NOT NULL, periodo char(1) NOT NULL, activo bool NOT NULL, grupo varchar(10) NOT NULL, CONSTRAINT materias_pkey PRIMARY KEY (id_grupo));
...
CREATE TABLE gestion2019.menus (idmenu serial NOT NULL, nombre varchar(40) NOT NULL, activo bool NOT NULL, descripcion varchar(255), CONSTRAINT menus_pkey PRIMARY KEY (idmenu));
...
CREATE TABLE gestion2019.mepro (idmenu int4 NOT NULL, idpro int4 NOT NULL, CONSTRAINT mepro_pkey PRIMARY KEY (idmenu, idpro));
...
CREATE TABLE gestion2019.procesos (idpro serial NOT NULL, nombre varchar(40) NOT NULL, enlace varchar(40) NOT NULL, descripcion varchar(60), CONSTRAINT procesos_pkey PRIMARY KEY (idpro));
...
CREATE TABLE gestion2019.programacion (idprog serial NOT NULL, idusu int4, grupoid_grupo int4, gestion char(4), Notafinal varchar(255), Estado bool NOT NULL, CONSTRAINT programacion_pkey PRIMARY KEY (idprog));
...
CREATE TABLE gestion2019.roles (idrol serial NOT NULL, nombre varchar(40) NOT NULL, activo bool NOT NULL, CONSTRAINT roles_pkey PRIMARY KEY (idrol));
...
CREATE TABLE gestion2019.rolme (idrol int4 NOT NULL, idmenu int4 NOT NULL, CONSTRAINT rolme_pkey PRIMARY KEY (idrol, idmenu));
...
CREATE TABLE gestion2019.universitarios (idusu int4 NOT NULL, ru int4 NOT NULL, CONSTRAINT universitarios_pkey PRIMARY KEY (idusu));
...
CREATE TABLE gestion2019.usurol (idusu int4 NOT NULL, idrol int4 NOT NULL, CONSTRAINT usurol_pkey PRIMARY KEY (idusu, idrol));
...
CREATE TABLE gestion2019.Proyectos (ID varchar(255) NOT NULL, programacionidprog2 int4 NOT NULL, AreaID int4 NOT NULL, Nota int4 NOT NULL, Estado bool NOT NULL, Titulo varchar(255), Resumen varchar(255), Archivo varchar(255), programacionidprog int4 NOT NULL, docentesidusu int4 NOT NULL, PRIMARY KEY (ID));
CREATE TABLE gestion2019.Tribunal (ID SERIAL NOT NULL, Memorandum varchar(255), ProyectosID varchar(255) NOT NULL, docentesidusu int4 NOT NULL, PRIMARY KEY (ID));
CREATE TABLE gestion2019.Observaciones (ID SERIAL NOT NULL, EtapasID int4 NOT NULL, TribunalID int4 NOT NULL, Fecha varchar(255), Archivo varchar(255), Observaciones varchar(255), PRIMARY KEY (ID));
CREATE TABLE gestion2019.Etapas (ID SERIAL NOT NULL, Nombre varchar(255), PRIMARY KEY (ID));
CREATE TABLE gestion2019.Area (ID SERIAL NOT NULL, Nombre varchar(255), PRIMARY KEY (ID));
CREATE TABLE gestion2019.Anuncios (ID SERIAL NOT NULL, usuariosidusu int4 NOT NULL, Fecha varchar(255), Titulo varchar(255), Mensaje varchar(255), Estado bool NOT NULL, Archivo varchar(255), PRIMARY KEY (ID));
